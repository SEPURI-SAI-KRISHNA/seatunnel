...
public class NumericFunctionTest {
    ...
    /**
     * ZetaSQLType derives the MOD result type from the divisor, so TINYINT and SMALLINT divisors
     * must yield values of those types instead of failing at runtime.
     */
    @Test
